...
<div class="form-detail">
			                    ...
			                    <div class="col-md-6 col-sm-6 line-colMB">
                                    <div class="bg-input">
				                        <div class="form-group">
					                        ...
					                        <label for="rdo_alsoOwner2"><div class="content-rdo-inline txtradio-inline">ที่อยู่เดียวกับคนที่ 1</div></label>
				                        </div>
                                    </div>
			                    </div>
			                    <div class="col-md-6 col-sm-6">
    ...
    <div class="btn-left-right">
        <button type="button" class="btn btn-gray btn-back" onclick="location.href='/Ecommerce/travel-insurance-around-thailiand?p=1'">
            <span class="icon-btn-arrow -left"><img src="/images/icon/p_btn_back.png" alt="icon"></span> <span class="text">BACK STEP</span>
            <div class="clearPrefix"></div>
        </button>
        <button type="button" class="btn btn-orange btn-next" onclick="location.href='/Ecommerce/travel-insurance-around-thailiand?p=4'">
