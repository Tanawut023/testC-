...
<div class="form-detail">
    ...
    <div class="text-topic text-center">
        ...
        <div class="desc">Fill in the insured's information</div>
    </div>
    <div class="tab-form">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="select-wrapper">
                                <select class="slc selectpicker-defalut" data-live-search="true" title="Plase Select">
                                    <option value="1">Personal car</option>
                        ...
                        <div class="bg-input">
                            <div class="form-group">
                                ...
                                <label for="rdo_check_round_trip">
                                    <div class="content-rdo-inline txtradio-inline">Round trip</div>
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-input">
                            <div class="form-group">
                                ...
                                <label for="rdo_check_oneway">
                                    <div class="content-rdo-inline txtradio-inline">Single trip</div>
                                </label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-7 col-sm-7">
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            <div class="select-wrapper">
                                <select class="slc selectpicker-defalut" data-live-search="true" title="Province">
        ...
        <!-- เพิ่มรายชื่อProvince -->
        <div class="row line-rowInput">
            <div class="col-md-5 col-sm-5 txt-title-middle">
                <label class="icon-note">*</label>
                Add Province
                <label class="icon-tooltip tooltips">
                    <img src="/Images/icon/icon-pop-over.png" class="tooltip" title="Please provide more detail in case you travel to other cities apart from what previously specified.  " />
                </label>
            ...
            <div class="col-md-7 col-sm-7">
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            <div class="select-wrapper">
                                <select class="slc selectpicker-defalut" id="addmore_province" data-live-search="true" title="Province" multiple data-max-options="3" data-max-options-text="Only two categories are allowed" mobile="true">
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                    <option value="4">4</option>
    ...
    <div class="condition-buy">
        ...
        <div class="txt-condition">I agree to enter into the insurance contract under the terms and <span class="condition_more">conditions >></span>
            <div class="detail-condition" style="display: none;">Coverage of the Company will not include any damage, defect or fault that exists before this insurance becomes effective, including equipment or integral part added by the factory standard. I agree to with the aforesaid sum insured and confirm that I do not have any criminal record concerning Anti-Money Laundering and Combating the Financing of Terrorism and Proliferation of Weapons of Mass Destruction Act or other related laws such as addictive drugs. I, hereby, certify that information provided above is true and accurate. </div>
        </div>
        <div class="txt-error err-condition"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> Please agree with the condition before proceed further.</div>
    </div>
    <div class="btn-left-right">
        <button type="button" class="btn btn-gray btn-back" onclick="location.href='/en/Ecommerce/travel-insurance-around-thailiand?p=1'"><span class="icon-btn-arrow -left">
            <img src="/images/icon/p_btn_back.png" alt="icon"></span> <span class="text">BACK STEP</span>
            <div class="clearPrefix"></div>
        </button>
        <button type="button" class="btn btn-orange btn-next" onclick="location.href='/en/Ecommerce/travel-insurance-around-thailiand?p=4'"><span class="text">NEXT STEP</span> <span class="icon-btn-arrow -right">
    ...
    <div class="detail-owner-collapse"><a data-toggle="collapse" href="#collapseWarning" aria-expanded="false" aria-controls="collapseWarning" class="collapsed">
        <div class="title-collapse bg-gray" id="collapse_warning">
            <div class="txt">Warning of OIC</div>
        ...
        <div class="detail-owner collapse" id="collapseWarning" style="height: 0px;" aria-expanded="false">
            ...
            <div class="warning"><span>Warning</span>
                announced by the office of insurance commission stated that all questions must be answered truthfully Otherwise the company may use it as a cause to deny liability of insurance contact under civil and comercial code section 865
            </div>
            <div class="annotation"><span>Remark</span> The coverage will be effective when this application form is complete and conect and approved by the company. </div>
            <!-- /คำเตือน + หมายเหตุ -->
        </div>
    </div>
</div>
