...
<div class="form-detail">
    ...
    <div class="text-topic text-center">
        ...
        <div class="desc">ช่วงอายุ 1 เดือน - 60 ปี</div>
    </div>
    <!-- ช่วงอายุผู้เอาประกัน -->
    <%--<div class="row line-rowInput"> <div class="col-md-5 col-sm-5 txt-title-checkbox"><label class="icon-note">*</label> ช่วงอายุผู้เอาประกัน</div> <div class="col-md-7 col-sm-7"> <div class="row"> <div class="col-md-6 col-sm-6"> <div class="form-group"> <div class="select-wrapper"> <select class="slc selectpicker-defalut" data-live-search="true" title="โปรดระบุ"> <option value="18-25">18-25</option> <option value="26-30">26-30</option> <option value="31-80">31-80</option> </select> </div> </div> </div> </div> </div> </div>--%>
    <!-- วันที่เดินทาง -->
                    ...
                    <div class="form-group">
                        <div class="select-wrapper">
                            <select id="slc_Tourism" class="slc selectpicker-defalut" data-live-search="true" title="โปรดระบุ">
                                ...
                                <option value="3">ท่องเที่ยว (Extreme activity)</option>
                                <option value="4">สัมมนา/อบรม/ประชุม/ดูงาน/ศึกษา</option>
                                <option value="5">ทำงาน/ฝึกงานประจำสำนักงาน</option>
                                <option value="6">จัดการแสดง/นิทรรศการ/ออกบูธ/โปรโมทสินค้า</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-input">
                        <div class="form-group">
                            ...
                            <label for="rdo_docThai">
                                <div class="content-rdo-inline txtradio-inline">ไทย</div>
                            </label>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-input">
                        <div class="form-group">
                            ...
                            <label for="rdo_docEng">
                                <div class="content-rdo-inline txtradio-inline">อังกฤษ</div>
                            </label>
                        </div>
                    </div>
                </div>
    ...
    <!-- วัตถุประสงค์ของการท่องเที่ยว -->
    <%--<div class="row line-rowInput"> <div class="col-md-5 col-sm-5 txt-title-middle"><label class="icon-note">*</label> วัตถุประสงค์ของการท่องเที่ยว <label class="icon-tooltip tooltips"> <img src="/Images/icon/icon-pop-over.png" class="tooltip"title="กิจกรรมที่ไม่ได้รับความคุ้มครอง ได้แก่ ล่าสัตว์, แข่งรถหรือแข่งเรือทุกชนิด, แข่งม้า, เล่นหรือแข่งสกีทุกชนิดรวมถึงเจ็ตสกี, แข่งสเก็ต, ชกมวย, โดดร่ม (เว้นแต่เป็นการโดดร่มเพื่อรักษาชีวิต), ขณะกำลังขึ้นหรือกำลังลงหรือโดยสารอยู่ในบอลลูน, เครื่องร่อน, เล่นบันจี้จั๊มพ์, ปีนหรือไต่เขา, ดำน้ำที่ต้องใช้ถังอากาศ" /> </label> <span class="tooltip"></span> </div> <div class="col-md-7 col-sm-7"> <div class="row"> <div class="col-md-6 col-sm-6"> <div class="form-group"> <div class="select-wrapper"> <select id="slc_Tourism" class="slc selectpicker-defalut" data-live-search="true" title="โปรดระบุ"> <option value="1">ท่องเที่ยว (ไม่มีกิจกรรมผาดโผน)</option> <option value="2">ท่องเที่ยว (มีกิจกรรมดำน้ำตื้น/ล่องแก่ง/ล่องแพ)</option> <option value="3">ท่องเที่ยว (Extreme activity)</option> <option value="4">สัมนา/อบรม/ประชุม/ดูงาน/ศึกษา</option> <option value="5">ทำงาน/ฝึกงานประจำสำนักงาน</option> <option value="6">จัดการแสดง/นิทรรศการ/ออกบูธ/โปรโมทสินค้า</option> </select> </div> </div> </div> <div class="col-md-6 col-sm-6 line-colMB-top" id="Other_Tourism" style="display: none;"> <div class="form-group"> <input class="filed-txt" type='text' placeholder="โปรดระบุ"/> </div> </div> </div> </div> </div>--%>
    <!-- ทุนประกัน -->
    ...
    <!-- ราคาเบี้ยประกัน -->
    <%--<div class="row line-rowInput" id="priceInsurance_Standard" style="display: block;"> <div class="col-md-5 col-sm-5 txt-title-middle"><label class="icon-note-hide">*</label> ราคาเบี้ยประกัน <!--<label class="icon-tooltip tooltips"> <img src="/Images/icon/icon-pop-over.png" class="tooltip" title="ราคานี้รวมส่วนลดติดตั้งกล้อง" /> </label> <span class="tooltip"></span>--> </div> <div class="col-md-7 col-sm-7"> <div class="text-Premium-rates"> <div class="main-price">24,000</div> <div class="point-price">.00</div> <div class="currency">บาท</div> <div class="clearPrefix"></div> </div> </div> </div>--%>
    <!-- เอกสารกรมธรรม์ -->
    ...
    <div class="text-right btn-reverse-mb">
        <button type="button" class="btn btn-gray btn-center" onclick="location.href='/Callcenter/ContactCallcenter'"><span class="text">
            ...
            ติดต่อเจ้าหน้าที่ </span></button>
        <button type="button" class="btn btn-orange btn-next" onclick="location.href='/Ecommerce/travel-insurance-around-thailiand?p=3'"><span class="text">NEXT STEP</span> <span class="icon-btn-arrow -right">
