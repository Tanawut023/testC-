...
<div class="form-detail">
	<div class="row">
		<div class="col-md-12 txt-title-checkout"><span>ประกันอัคคีภัยสำหรับบ้านอยู่อาศัย</span></div>
	</div>
	<div class="row">
		<div class="col-md-5">
			<div class="row">
				<div class="col-md-12 txt-title">เลขที่ใบสั่งซื้อ <span class="txt-detail-title">1983737465</span></div>
			</div>
		</div>
		<div class="col-md-7">
			<div class="row">
				<div class="col-md-12 txt-title">ยอดค้างชำระ <span class="txt-detail-title">10,145.00 บาท</span></div>
			</div>
		</div>
	</div>
    <div class="row">
