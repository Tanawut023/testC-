...
<div class="form-detail">
    <div class="title-form-search">ค้นหาจุดให้บริการ</div>
                    ...
                    <div id="formGarage" class="form-categories">
                        ...
                        <div class="HidegarageKeyword">
                            <div class="row rowMB">
                                <div class="col-md-12">
                                    <div class="form-group">
						                <input type='text' placeholder="Your Keyword" disabled="disabled"/>
					                </div>
                                </div>
                            </div>
                            <div class="row rowMB">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
						                <select class="selectpicker-defalut form-control" title="จังหวัด" data-live-search="true" data-container="body" disabled="disabled">
							                <option>1</option>
							                <option>2</option>
							                <option>3</option>
							                <option>4</option>
