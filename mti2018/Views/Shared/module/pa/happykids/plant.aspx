...
<div class="form-detail">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="packageInsured active" id="packageOne">
                        ...
                        <div class="item-package" id="package_first">
                            <div class="header pa">ทุนประกัน 200,000.00 บาท</div>
                            <div class="detail-wrapper">
                                <div class="icon-check"></div>
                                <div class="price">
                                    <div class="money">
                                        <span class="main-price">1,500</span><span class="point">.00</span>
                                    </div>
                    ...
                    <div class="packageInsured" id="packageSecond">
                        ...
                        <div class="item-package" id="package_second">
                            ...
                            <div class="detail-wrapper">
                                ...
                                <div class="price">
                                    <div class="money">
                                        <span class="main-price">2,000</span><span class="point">.00</span>
                                    </div>
                                    <div class="current">บาท</div>
                                </div>
                                <div class="clearPrefix"></div>
                    ...
                    <div class="packageInsured" id="packageThrid">
                        ...
                        <div class="item-package" id="package_thrid">
                            ...
                            <div class="detail-wrapper">
                                ...
                                <div class="price">
                                    <div class="money">
                                        <span class="main-price">2,500</span><span class="point">.00</span>
                                    </div>
                                    <div class="current">บาท</div>
                                </div>
                                <div class="clearPrefix"></div>
    ...
    <div class="text-right btn-reverse-mb">
        ...
        <button type="button" class="btn btn-orange btn-next" onclick="location.href='/Ecommerce/personal-accident-muangthai-happy-kids?p=3'">
