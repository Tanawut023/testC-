...
<div class="form-detail">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="packageInsured active" id="packageOne">
                        ...
                        <div class="item-package" id="package_first">
                            <div class="header pa">ทุนประกัน 300,000.00 บาท</div>
                            <div class="detail-wrapper">
                                <div class="icon-check"></div>
                                <div class="price">
                                    <div class="money">
                                        <span class="main-price">1,600</span><span class="point">.00</span>
                                    </div>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="packageInsured" id="packageSecond">
                        ...
                        <div class="item-package" id="package_second">
                            <div class="header pa">ทุนประกัน 500,000.00 บาท</div>
                            <div class="detail-wrapper">
                                <div class="icon-check"></div>
                                <div class="price">
                                    <div class="money">
                                        <span class="main-price">2,100</span><span class="point">.00</span>
                                    </div>
                                    <div class="current">บาท</div>
                                </div>
                                <div class="clearPrefix"></div>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="packageInsured" id="packageThrid">
                        ...
                        <div class="item-package" id="package_thrid">
                            <div class="header pa">ทุนประกัน 1,000,000.00 บาท</div>
                            <div class="detail-wrapper">
                                <div class="icon-check"></div>
                                <div class="price">
                                    <div class="money">
                                        <span class="main-price">3,000</span><span class="point">.00</span>
                                    </div>
                                    <div class="current">บาท</div>
                                </div>
                                <div class="clearPrefix"></div>
    ...
    <div class="text-right btn-reverse-mb">
        ...
        <button type="button" class="btn btn-orange btn-next" onclick="location.href='/Ecommerce/personal-accident-muangthai-your-happy?p=3'">
