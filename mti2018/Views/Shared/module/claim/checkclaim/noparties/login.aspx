...
<div class="form-claim-login">
    <div class="form-detail">
        <div class="header">
            ...
            <div class="desc-formLogin">กรุณากรอกเลขที่กรมธรรม์และเลขที่บัตรประชาชนเพื่อเป็นการยืนยันตัวตน</div>
        </div>
        <div class="content-login">
            ...
            <div class="row">
		        <div class="col-md-5 col-sm-5 txt-title-middle"><label class="icon-note">*</label> เลขที่บัตรประชาชน</div>
		        <div class="col-md-7 col-sm-7">
			        <div class="row">
				        <div class="col-md-11 col-sm-11">
					        <div class="form-group">
						        <input type='text' placeholder="เลขที่บัตรประชาชน 13 หลัก"/>
            ...
            <div class="text-right">
                <button type="submit" class="btn btn-orange" onclick="location.href='/Claim/Checknoparties?p=2'">Verify 
