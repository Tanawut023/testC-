    ...
    <div class="form-detail">
        ...
        <div class="detail-status">
            ...
            <div class="content-images">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="item-content">
                                <div class="title-item">
                                    ...
                                    <div class="txt-title-item">รูปถ่ายใบขับขี่หน้า-หลัง (ของผู้ขับขี่)</div>
                                    <div class="clearPrefix"></div>
                                </div>
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="item-content">
                                <div class="title-item">
                                    ...
                                    <div class="txt-title-item">รูปถ่ายด้านหน้ารถเห็น ป้ายทะเบียน</div>
                                    <div class="clearPrefix"></div>
                                </div>
                                <div class="detail-item">
                                    <div class="row">
                ...
                <%-- หัวข้อ 3 --%>
                <div class="section-box br-blue">
                     <div class="row">
                         <div class="col-md-12">
                             <div class="item-content">
                                 <div class="title-item">
                                    <div class="number">03</div>
                                    <div class="txt-title-item">รายการภาพชิ้นส่วน ที่เสียหาย</div>
                                    <div class="clearPrefix"></div>
                                </div>
                             </div>
                         </div>
         ...
         <%-- ปุ่ม --%>
        <div class="text-left">
		    <button type="button" class="btn btn-blue" style="font-size: 22px; margin-left: 0;">..คลิก.. เพื่อทำการแก้ไขข้อมูล <i class="fa fa-caret-right" aria-hidden="true"></i></button>
	    </div>
