...
<div class="form-claim">
    ...
    <div class="form-detail">
        ...
        <%-- ปุ่ม --%>
        <div class="text-right">
            <button type="submit" class="btn btn-orange" onclick="location.href='/Claim/Informnopartiespa?p=8'">
...
<script src="../../../../../../../Scripts/ValidateClaimPAalone.js"></script>
<script type="text/javascript">
$(document).ready(function () {
    //CheckClaimPAalone();
    CheckClaimPAaloneVII();
    ...
    $('input[name=rdo_checkotherinsureOwnerTP1]').click(function () {
        if (this.id == 'rdo_checkyes_oiOwnerTP1') {
            $(this).closest('.detailaccident3').find('.clickShow').show();
        }
        else {
            $(this).closest('.detailaccident3').find('.clickShow').hide();
        }
    });
