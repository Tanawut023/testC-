...
<div class="form-claim">
    ...
    <div class="form-detail">
                ...
                <div class="box-claim-detail-car">
                    <ul>
                        ...
                        <li>
                            <div class="header">
                                <div class="title">
                                    <img src="/Images/icon/icon-expprotection2.png" /> ระยะเวลาเอาประกัน
                                </div>
                            </div>
        ...
        <div class="Tab-checkbox">
            <ul>
                <li id="TabforMain">
                    <input type="checkbox" id="chk_Owner" name="chk_Owner"/>
                    <a>
                        <div class="icon-check"></div>
                        <div class="text">ผู้เอาประกันภัย</div>
                    </a>
                </li>
                <li id="TabforSecond">
                    <input type="checkbox" id="chk_Mate" name="chk_Mate"/>
                    <a>
                        <div class="icon-check"></div>
                        <div class="text">คู่สมรส</div>
                    </a>
                </li>
                <li id="TabforThird">
                    <input type="checkbox" id="chk_Sonfirst" name="chk_Sonfirst"/>
                    <a>
                        <div class="icon-check"></div>
                        <div class="text">บุตรคนที่ 1</div>
                    </a>
                </li>
                <li id="TabforFourth" class="disable">
                    <input type="checkbox" id="chk_Sonsecond" name="chk_Sonsecond"/>
                    <a>
                        <div class="icon-check"></div>
                        <div class="text">บุตรคนที่ 2</div>
                    </a>
                </li>
                <div class="clearPrefix"></div>
            </ul>
        </div>
        <div class="content-Tab-checkbox">
            ...
            <div class="row" id="forThird">
                <div class="col-md-4 txt-title-middle">ชื่อ / นามสกุลบุตรคนที่ 1</div>
                <div class="col-md-8">
			        <div class="row">
				        <div class="col-md-6 col-sm-6">
					        <div class="form-group">
            ...
            <div class="row" id="forFourth">
                <div class="col-md-4 txt-title-middle">ชื่อ / นามสกุลบุตรคนที่ 2</div>
                <div class="col-md-8">
			        <div class="row">
				        <div class="col-md-6 col-sm-6">
					        <div class="form-group">
        ...
        <div class="text-right">
            <button type="submit" class="btn btn-orange" onclick="location.href='/Claim/Informnopartiespa?p=4'">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.Tab-checkbox ul li').click(function () {
            if ($(this).hasClass('disable') == false) {
                $(this).toggleClass('active');
                // ผู้เอาประกัน
                if ($('#TabforMain').hasClass('active')) {
                    $(this).find('#chk_Owner').prop("checked", true);
                    $('#forMain').show();
                } else {
                    $(this).find('#chk_Owner').prop("checked", false);
                    $('#forMain').hide();
                }
                // คู่สมรส
                if ($('#TabforSecond').hasClass('active')) {
                    $(this).find('#chk_Mate').prop("checked", true);
                    $('#forSecond').show();
                } else {
                    $(this).find('#chk_Mate').prop("checked", false);
                    $('#forSecond').hide();
                }
                // บุตรคนที่1
                if ($('#TabforThird').hasClass('active')) {
                    $(this).find('#chk_Sonfirst').prop("checked", true);
                    $('#forThird').show();
                } else {
                    $(this).find('#chk_Sonfirst').prop("checked", false);
                    $('#forThird').hide();
                }
                // บุตรคนที่2
                if ($('#TabforFourth').hasClass('active')) {
                    $(this).find('#chk_Sonsecond').prop("checked", true);
                    $('#forFourth').show();
                } else {
                    $(this).find('#chk_Sonsecond').prop("checked", false);
                    $('#forFourth').hide();
                }
            }
