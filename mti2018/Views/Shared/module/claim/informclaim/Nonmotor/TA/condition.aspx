...
<div class="form-claim" style="padding: 10px 20px 40px;">
    <div class="form-detail">
        <div class="row">
		    <div class="col-md-12 txt-title-checkout"><span>แจ้งเคลมประกันการเดินทาง</span></div>
	    </div>
        <div class="row">
        ...
        <div class="list-condition">
            <ul>
                ...
                <li>บริษัทฯ อาจมีขอเอกสารเพิ่มเติมจากที่ระบุไว้ ในกรณีที่เอกสารนั้นจำเป็นต่อการพิจารณาอนุมัติ</li>
                <li>ขอสงวนสิทธิ์การแจ้งเคลมผ่านระบบออนไลน์เฉพาะกรมธรรม์ประกันเดินทาง เมืองไทย Happy Mile Travel  เมืองไทย Enjoy Travel  เมืองไทย Enjoy Visa Plan และเป็นกรมธรรม์แบบรายเดี่ยวเท่านั้น</li>
            </ul>
        </div>
        <!-- กดยอมรับ -->
        ...
        <div class="float-left mob-FL">
            <button type="button" class="btn btn-blue" onclick="location.href='/Claim/Informnopartiespa?p=#'" style="margin-left: 0;">
                เอกสารประกอบการแจ้งเคลม<i class="fa fa-caret-right" aria-hidden="true"></i>
            </button>
        </div>
        <div class="float-right">
            <button type="submit" class="btn btn-gray" onclick="location.href='/Claim/Informnopartiesta?p=1'">
                Cancel<i class="fa fa-caret-right" aria-hidden="true"></i>
            </button>
            <button type="submit" class="btn btn-orange" onclick="location.href='/Claim/Informnopartiesta?p=3'">
