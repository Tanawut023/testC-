    ...
    <div class="form-detail">
        ...
        <div id="Paclaim_owner">
            ...
            <div class="detail-report-collapse">
                ...
                <!-- กรณีเสียชีวิต -->
                <div>
                    <a data-toggle="collapse" href="#collapseReportTab1_2" aria-expanded="false" aria-controls="collapseReportTab1_2">
                        <div class="title-collapse" id="accorT1_2">
                        ...
                        <div class="last-report">
                            <ul>
                                ...
                                <li class="box height-scp width-0">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 col-sm-6 txt-topic">จำนวนเงินเรียกร้องสินไหม</div>
                                        <div class="col-md-7 col-sm-6 txt-detail">
                                            50,000.00 บาท
                                        </div>
                                    </div>
                                ...
                                <li class="box height-scp width-0">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">1.สำเนาใบชัณสูตรพลิกศพ รับรองสำเนาโดยหน่วยงานที่ออก</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 3 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/demo-claimmotor1.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                                </div>
                                                <div class="icon-file">
                                                    <img src="/Images/demo-claimmotor1.png" alt="icon" />
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">2.สำเนารับรองการเสียชีวิต รับรองสำเนาโดยหน่วยงานที่ออก</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 3 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/demo-claimmotor2.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                                </div>
                                                <div class="icon-file">
                                                    <img src="/Images/demo-claimmotor2.png" alt="icon" />
                                                </div>
                                            </div>
                                            <div class="txt-sizefile">
                                                <span>.JPG</span> - 2.2 MB
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">3.สำเนาใบมรณะบัตร รับรองสำเนาโดยหน่วยงานที่ออก</div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">4.สำเนาบันทึกประจำวันตำรวจ รับรองสำเนาโดยร้อยเวรเจ้าของคดี</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">5.สำเนาทะเบียนบ้านของผู้เสียชีวิตรับรองสำเนาโดยผู้รับประโยชน์</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">6.สำเนาบัตรประชาชนของผู้เสียชีวิตรับรองสำเนาโดยผู้รับประโยชน์</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">7.สำเนาทะเบียนบ้านของผู้รับประโยชน์รับรองสำเนาถูกต้อง</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">8.สำเนาใบรายงานการผ่าศพ (ถ้ามี)</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">9.สำเนาบัตรรับประกันภัย (ถ้ามี)</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">10.ภาพข่าว (ถ้ามี)</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                ...
                                <%--<li class="box height-scp width-0">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic-previreimg">1.สำเนาหนังสือเดินทางรับรองสำเนาถูกต้อง</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <!--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic-previreimg">2.สำเนาหน้าบัญชีธนาคาร</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <!--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                ...
                <div>
                    <a data-toggle="collapse" href="#collapseReportTab1_3" aria-expanded="false" aria-controls="collapseReportTab1_3">
                        <div class="title-collapse" id="accorT1_3">
                        ...
                        <div class="last-report">
                            <ul>
                                ...
                                <li class="box height-scp width-0">
                                    <div class="title-inbox">หลักฐานประกอบการแจ้งเคลม</div>
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">1.ใบรับรองแพทย์ ระบุสาเหตุการบาดเจ็บและอวัยวะที่สูญเสียโดยชัดเจน</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <!--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">2.รูปถ่ายเต็มตัวและอวัยวะที่สูญเสียของผู้เรียกร้องสิทธิความคุ้มครอง</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">3.ผลอ่านฟิล์มเอ็กซเรย์</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">4.สำเนาประวัติการรักษา</div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">5.สำเนาบัตรรับประกันภัย (ถ้ามี)</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">6.ภาพข่าว (ถ้ามี)</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                ...
                <div>
                    <a data-toggle="collapse" href="#collapseReportTab1_6" aria-expanded="false" aria-controls="collapseReportTab1_6">
                        <div class="title-collapse" id="accorT1_6">
                        ...
                        <div class="last-report">
                            <ul>
                                ...
                                <li class="box height-scp width-0">
                                    <div class="title-inbox">หลักฐานประกอบการแจ้งเคลม</div>
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">1.ใบรับรองแพทย์ฉบับจริง</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">2.ใบเสร็จรับเงินฉบับจริง</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 2 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">3.สำเนาบัตรรับประกันภัย (ถ้ามี)</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                ...
                <div>
                    <a data-toggle="collapse" href="#collapseReportTab1_7" aria-expanded="false" aria-controls="collapseReportTab1_7">
                        <div class="title-collapse" id="accorT1_7">
                            <div class="txt">การบอกเลิกการเดินทาง</div>
                            <div class="icon"><i class="fa fa-caret-right" aria-hidden="true"></i></div>
                            <div class="clearPrefix"></div>
                        </div>
                    </a>
                    <div class="collapse" id="collapseReportTab1_7">
                        <div class="last-report">
                            <ul>
                                <!-- รายละเอียด -->
                                <li class="box height-scp width-0">
                                ...
                                <li class="box height-scp width-0">
                                    <div class="title-inbox">หลักฐานประกอบการแจ้งเคลม</div>
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">1.ใบรับรองแพทย์ฉบับจริง (กรณีเกิดอุบัติเหตุหรือเจ็บป่วย ของผู้เอาประกันภัย หรือญาติ)</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">2.สำเนาใบมรณะบัตร (กรณีการเสียชีวิตของผู้เอาประกันภัย หรือญาติ)</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 2 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">3.เอกสารการยกเลิกการเดินทางของผู้ขนส่ง</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">4.เอกสารการชดใช้ของผู้ขนส่ง (กรณีผู้ขนส่งเป็นผู้ยกเลิกการเดินทาง)</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">5.ใบเสร็จรับเงินต้นฉบับแสดงค่ามัดจำหรือค่าจองล่วงหน้าสำหรับการเดินทาง</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                ...
                <div>
                    <a data-toggle="collapse" href="#collapseReportTab1_8" aria-expanded="false" aria-controls="collapseReportTab1_8">
                        <div class="title-collapse" id="accorT1_8">
                            <div class="txt">การลดจำนวนวันเดินทาง</div>
                            <div class="icon"><i class="fa fa-caret-right" aria-hidden="true"></i></div>
                            <div class="clearPrefix"></div>
                        </div>
                    </a>
                    <div class="collapse" id="collapseReportTab1_8">
                        <div class="last-report">
                            <ul>
                                <!-- รายละเอียด -->
                                <li class="box height-scp width-0">
                                ...
                                <li class="box height-scp width-0">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">3.เอกสารการชดใช้ของผู้ขนส่ง (กรณีผู้ขนส่งเป็นผู้ยกเลิกการเดินทาง)</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">
                                            4.ใบเสร็จรับเงินต้นฉบับแสดงค่ามัดจำหรือค่าจองล่วงหน้าสำหรับการเดินทาง
                                        </div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                ...
                <!-- การจี้โดยสลัดอากาศ -->
                <div>
                    <a data-toggle="collapse" href="#collapseReportTab1_9" aria-expanded="false" aria-controls="collapseReportTab1_9">
                        <div class="title-collapse" id="accorT1_9">
                            <div class="txt">การจี้โดยสลัดอากาศ</div>
                            <div class="icon"><i class="fa fa-caret-right" aria-hidden="true"></i></div>
                            <div class="clearPrefix"></div>
                        </div>
                    </a>
                    <div class="collapse" id="collapseReportTab1_9">
                        <div class="last-report">
                            <ul>
                                <!-- รายละเอียด -->
                                <li class="box height-scp width-0">
                                ...
                                <li class="box height-scp width-0">
                                    <div class="title-inbox">หลักฐานประกอบการแจ้งเคลม</div>
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">1.ตั๋วเครื่องบิน (Boarding Pass)</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">2.หนังสือยืนยันเหตุการณ์จากสายการบิน/ท่าอากาศยานระบุสาเหตุและระยะเวลาของการจี้เครื่องบิน</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">3.เอกสารชดใช้จากผู้ขนส่ง (ถ้ามี)</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                ...
                <div>
                    <a data-toggle="collapse" href="#collapseReportTab1_10" aria-expanded="false" aria-controls="collapseReportTab1_10">
                        <div class="title-collapse" id="accorT1_10">
                            <div class="txt">การล่าช้าของการเดินทาง</div>
                            <div class="icon"><i class="fa fa-caret-right" aria-hidden="true"></i></div>
                            <div class="clearPrefix"></div>
                        </div>
                    </a>
                    <div class="collapse" id="collapseReportTab1_10">
                        <div class="last-report">
                            <ul>
                                <!-- รายละเอียด -->
                                <li class="box height-scp width-0">
                                ...
                                <li class="box height-scp width-0">
                                    <div class="title-inbox">หลักฐานประกอบการแจ้งเคลม</div>
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">1.ใบแจ้งและยืนยันการล่าช้าจากผู้ขนส่งอธิบายเหตุผลการล่าช้า</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">2.เอกสารการชดใช้ของผู้ขนส่ง กรณีเครื่องจักรกลของผู้ขนส่งชำรุด</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">
                                            3.ใบเสร็จรับเงินแสดงรายการค่าใช้จ่ายต้นฉบับที่ผู้เอาประกันภัยได้จ่ายไปขณะเดินทางล่าช้า
                                        </div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                ...
                <div>
                    <a data-toggle="collapse" href="#collapseReportTab1_11" aria-expanded="false" aria-controls="collapseReportTab1_11">
                        <div class="title-collapse" id="accorT1_11">
                            <div class="txt">การสูญเสียหรือเสียหายของกระเป๋าเดินทาง</div>
                            <div class="icon"><i class="fa fa-caret-right" aria-hidden="true"></i></div>
                            <div class="clearPrefix"></div>
                        </div>
                    </a>
                    <div class="collapse" id="collapseReportTab1_11">
                        <div class="last-report">
                            <ul>
                                <!-- รายละเอียด -->
                                <li class="box height-scp width-0">
                                ...
                                <li class="box height-scp width-0">
                                    <div class="title-inbox">หลักฐานประกอบการแจ้งเคลม</div>
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">1.บันทึกประจำวันของเจ้าหน้าที่ตำรวจตามที่ผู้เอาประกันภัยได้แจ้งความไว้</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">2.เอกสารยืนยันสูญหายซึ่งออกโดยผู้ขนส่ง ผู้จัดการหรือเจ้าของสถานพำนักที่ผู้เอาประกันภัยพัก</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">
                                            3.เอกสารแสดงการชดใช้ของผู้ขนส่ง ผู้จัดการหรือเจ้าของสถานพำนัก
                                        </div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">
                                            4.ใบเสร็จรับเงินค่าซ่อมแซมกระเป๋า
                                        </div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                ...
                <div>
                    <a data-toggle="collapse" href="#collapseReportTab1_12" aria-expanded="false" aria-controls="collapseReportTab1_12">
                        <div class="title-collapse" id="accorT1_12">
                            <div class="txt">การล่าช้าของกระเป๋าเดินทาง</div>
                            <div class="icon"><i class="fa fa-caret-right" aria-hidden="true"></i></div>
                            <div class="clearPrefix"></div>
                        </div>
                    </a>
                    <div class="collapse" id="collapseReportTab1_12">
                        <div class="last-report">
                            <ul>
                                <!-- รายละเอียด -->
                                <li class="box height-scp width-0">
                                ...
                                <li class="box height-scp width-0">
                                    <div class="title-inbox">หลักฐานประกอบการแจ้งเคลม</div>
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">1.เอกสารยืนยันการล่าช้าของกระเป๋าเดินทางซึ่งออกโดยผู้ขนส่ง</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">
                                            2.ใบเสร็จรับเงินแสดงรายการค่าใช้จ่ายต้นฉบับที่ผู้เอาประกันภัยได้จ่ายไปขณะที่กระเป่าเดินทางมาถึงล่าช้า
                                        </div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">
                                            3.เอกสารแสดงการชดใช้ของผู้ขนส่ง
                                        </div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                ...
                <div>
                    <a data-toggle="collapse" href="#collapseReportTab1_13" aria-expanded="false" aria-controls="collapseReportTab1_13">
                        <div class="title-collapse" id="accorT1_13">
                            <div class="txt">ความรับผิดต่อบุคคลภายนอก</div>
                            <div class="icon"><i class="fa fa-caret-right" aria-hidden="true"></i></div>
                            <div class="clearPrefix"></div>
                        </div>
                    </a>
                    <div class="collapse" id="collapseReportTab1_13">
                        <div class="last-report">
                            <ul>
                                <!-- รายละเอียด -->
                                <li class="box height-scp width-0">
                                ...
                                <li class="box height-scp width-0">
                                    <div class="title-inbox">หลักฐานประกอบการแจ้งเคลม</div>
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">1.ใบรับรองแพทย์ (กรณีบาดเจ็บ)</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">
                                            2.ใบเสร็จรับเงินค่ารักษาพยาบาล(กรณีบาดเจ็บ)
                                        </div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">
                                            3.สำเนาบัตรประชาชนของบุคคลภายนอกที่บาดเจ็บรับรองสำเนาถูกต้อง (กรณีบาดเจ็บ)
                                        </div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">
                                            4.ใบเสร็จค่าซ่อมแซมทรัพย์สิน/ใบเสร็จรับเงินกรณีจำเป็นต้องซื้อทรัพย์สินจากเจ้าของทรัพย์สินนั้น
                                        </div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                ...
                <!-- การพลาดต่อเที่ยวบิน -->
                <div>
                    <a data-toggle="collapse" href="#collapseReportTab1_14" aria-expanded="false" aria-controls="collapseReportTab1_14">
                        <div class="title-collapse" id="accorT1_14">
                            <div class="txt">การพลาดต่อเที่ยวบิน</div>
                            <div class="icon"><i class="fa fa-caret-right" aria-hidden="true"></i></div>
                            <div class="clearPrefix"></div>
                        </div>
                    </a>
                    <div class="collapse" id="collapseReportTab1_14">
                        <div class="last-report">
                            <ul>
                                <!-- รายละเอียด -->
                                <li class="box height-scp width-0">
                                ...
                                <li class="box height-scp width-0">
                                    <div class="title-inbox">หลักฐานประกอบการแจ้งเคลม</div>
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">1.หนังสือยืนยันเหตุการณ์จากสายการบิน/ท่าอากาศยาน ระบุสาเหตุและระยะเวลาของการพลาดการต่อเที่ยวบิน</div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                                    <img src="/Images/icon/icon-zoom.png" />
                ...
                <div>
                    <a data-toggle="collapse" href="#collapseReportTab1_15" aria-expanded="false" aria-controls="collapseReportTab1_15">
                        <div class="title-collapse" id="accorT1_15">
                            <div class="txt">การสูญเสียหรือเสียหายของเงินส่วนตัว</div>
                            <div class="icon"><i class="fa fa-caret-right" aria-hidden="true"></i></div>
                            <div class="clearPrefix"></div>
                        </div>
                    </a>
                    <div class="collapse" id="collapseReportTab1_15">
                        <div class="last-report">
                            <ul>
                                <!-- รายละเอียด -->
                                <li class="box height-scp width-0">
                                ...
                                <li class="box height-scp width-0">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">
                                            1.สำเนาบันทึกประจำวันของตำรวจในท้องที่ที่เกิดเหตุ
                                        </div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                ...
                <div>
                    <a data-toggle="collapse" href="#collapseReportTab1_16" aria-expanded="false" aria-controls="collapseReportTab1_16">
                        <div class="title-collapse" id="accorT1_16">
                            <div class="txt">ผลประโยชน์ชดเชยค่าโทรศัพท์ในกรณีฉุกเฉิน</div>
                            <div class="icon"><i class="fa fa-caret-right" aria-hidden="true"></i></div>
                            <div class="clearPrefix"></div>
                        </div>
                    </a>
                    <div class="collapse" id="collapseReportTab1_16">
                        <div class="last-report">
                            <ul>
                                <!-- รายละเอียด -->
                                <li class="box height-scp width-0">
                ...
                <div>
                    <a data-toggle="collapse" href="#collapseReportTab1_17" aria-expanded="false" aria-controls="collapseReportTab1_17">
                        <div class="title-collapse" id="accorT1_17">
                            <div class="txt">ผลประโยชน์ความคุ้มครองเอกสารการเดินทาง</div>
                            <div class="icon"><i class="fa fa-caret-right" aria-hidden="true"></i></div>
                            <div class="clearPrefix"></div>
                        </div>
                    </a>
                    <div class="collapse" id="collapseReportTab1_17">
                        <div class="last-report">
                            <ul>
                                <!-- รายละเอียด -->
                                <li class="box height-scp width-0">
                                ...
                                <li class="box height-scp width-0">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">
                                            1.สำเนาบันทึกประจำวันของตำรวจท้องที่ที่เกิดเหตุ
                                        </div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-9 txt-topic">
                                            2.ใบเสร็จรับเงินสำหรับค่าใช้จ่ายในการจัดทำเอกสารการเดินทางใหม่
                                        </div>
                                        <div class="col-md-3 col-sm-3 txt-detail"> 1 ใบ
                                            <%--<div class="preview">
                                                <div class="icon-preview" data-img="/Images/image-demo-document.png">
                ...
                <!-- ปุ่ม(แก้ไขข้อมูล) -->
                <div class="text-left">
		            <button type="button" class="btn btn-blue btn-edit">แก้ไขข้อมูลของคุณ <i class="fa fa-caret-right" aria-hidden="true"></i></button>
	            </div>
            </div>
        </div>
