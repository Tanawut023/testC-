...
<div class="form-claim-login">
    <div class="form-detail">
        <div class="header">
            <div class="title-formLogin">แจ้งเคลมประกันการเดินทาง</div>
        ...
        <div class="content-login">
                                ...
                                <div class="form-error arrow_box" id="noInsuranceInvalid">
                                    <div class="detail-form-error">
                                        ...
                                        <div class="text-head-error">
                                            <span>ขออภัยค่ะ</span> เลขที่กรมธรรม์ของท่าน ไม่ถูกต้อง กรุณาตรวจสอบข้อมูลอีกครั้ง หรือ กรุณาระบุข้อมูลเพื่อให้เจ้าหน้าที่ติดต่อกลับ
                                        </div>
            ...
            <div class="text-right">
                <button id="btnVerify" type="button" class="btn btn-orange" onclick="location.href='/Claim/Informnopartiesta?p=2'">Verify
