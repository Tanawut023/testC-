            ...
            <div class="col-md-9">
                <div class="sectionDetailContact">
                    <div class="title-description">
                        <div class="title">ผลิตภัณฑ์ประกันภัยอุบัติเหตุ</div>
                        <div class="description">กรุณาเลือกโปรดักที่ต้องการ</div>
                    </div>

                    <!-- ผลิตภัณฑ์ประกันภัยอุบัติเหตุ -->
                    <div class="box-product">
                        <div class="row">
                            <div class="col-md-6 col-sm-6 box-type">
                                <a href="#">
                                    <div class="typeProduct">
                                        <div class="iconProduct">
                                            <img src="../Images/icon/contact/pa/icon-happy.png" alt="icon"/>
                                        </div>
                                        <div class="txtProduct">เมืองไทย P.A. Your Happy</div>
                                        <div class="clearPrefix"></div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-6 col-sm-6 box-type">
                                <a href="#">
                                    <div class="typeProduct">
                                        <div class="iconProduct">
                                            <img src="../Images/icon/contact/pa/icon-family.png" alt="icon"/>
                                        </div>
                                        <div class="txtProduct">เมืองไทย P.A Happy Family</div>
                                        <div class="clearPrefix"></div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-6 col-sm-6 box-type">
                                <a href="#">
                                    <div class="typeProduct">
                                        <div class="iconProduct">
                                            <img src="../Images/icon/contact/pa/icon-kids.png" alt="icon"/>
                                        </div>
                                        <div class="txtProduct">เมืองไทย P.A Happy Kids</div>
                                        <div class="clearPrefix"></div>
                                    </div>
                                </a>
                            </div>
