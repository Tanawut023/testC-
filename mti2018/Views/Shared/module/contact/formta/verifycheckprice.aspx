...
<div class="main-content-contact">
	<div class="container form-detail">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="sectionDetailContact form-detail">
                    <div class="title-description">
                        <div class="title">เช็คราคาและคำนวณเบี้ย</div>
                        <div class="description">กรุณาตอบคำถามเพื่อเช็คราคา และคำนวณเบี้ยประกันภัย</div>
                    </div>

                    <!-- #include file ="plant.aspx" -->
                </div>
            </div>
        </div>
	</div>
