            ...
            <div class="col-md-9">
                <div class="sectionDetailContact">
                    <div class="title-description">
                        <div class="title">ต่ออายุออนไลน์</div>
                    ...
                    <div class="showContent">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 txt-title">
                                <div class="title">ชื่อผู้เอาประกันภัย</div> <div class="detail">สมศักดิ์ มหาดำรงกุล</div>
                            </div>
                            <div class="col-md-6 col-sm-6 txt-title">
                        ...
                        <div class="box-detailInsurance">
                            ...
                            <div class="detailOwner detailOwner-renew">
                                <div class="row">
                            ...
                            <!-- สรุปราคาเบี้ยประกันภัยต่ออายุ -->
                            <div class="detailOwner box-report-renew">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="left">
                                            <div class="header">
                                                <div class="icon">
                                                    <img src="../Images/icon/contact/icon-totalrenew.png" alt="icon" />
                                                </div>
                                                <div class="text">
                                                    สรุปราคาเบี้ยประกันภัยต่ออายุ
                                                </div>
                                            ...
                                            <div class="content">
                                                <div class="txt-detail">
                                                    <div class="title">ทุนประกัน</div>
                                                    <div class="txt-price">100,000 บาท</div>
                                                    <div class="clearPrefix"></div>
                                                </div>
                                                <div class="txt-detail" style="margin-top: 5px;">
                                                    <div class="title">เบี้ยประกันภัย<br><span>(รวมภาษีอากร)</span></div>
                                                    <div class="txt-price2x">12,000<label class="pointer">.00</label> <label class="txt-currency">บาท</label></div>
                                                    <div class="clearPrefix"></div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="note-btn">
                                <div class="sec-note">
                                    <img src="../Images/icon/icon-alert-warning.png" alt="icon"/> เบี้ยประกันภัยอาจจะการเปลี่ยนแปลง กรณีมีการเคลมหลังวันที่ .... (วันที่ออกใบเตือน)
                                </div>
                                <div class="sec-btn">
                                    <button type="submit" class="btn btn-orange">
                                        ต่ออายุกรมธรรม์ <i class="fa fa-caret-right" aria-hidden="true"></i>
		                            </button>
                                </div>
                                <div class="clearPrefix"></div>
                            </div>
