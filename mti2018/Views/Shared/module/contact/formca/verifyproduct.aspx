            ...
            <div class="col-md-8">
                <div class="sectionDetailContact">
                    <div class="title-description">
                        <div class="title">ผลิตภัณฑ์ประกันภัยสุขภาพและโรคร้ายแรง</div>
                        <div class="description">กรุณาเลือกโปรดักที่ต้องการ</div>
                    </div>

                    <!-- ผลิตภัณฑ์ประกันภัยสุขภาพและโรคร้ายแรง -->
                        ...
                        <div class="row">
                                ...
                                <a href="#">
                                    <div class="typeProduct">
                                        <div class="iconProduct">
                                            <img src="../Images/icon/contact/health/icon-cancer.png" alt="icon"/>
                                        </div>
                                        <div class="txtProduct">เมืองไทย Smile Cancer</div>
                                        <div class="clearPrefix"></div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-6 col-sm-6 box-type">
                                <a href="#">
                                    <div class="typeProduct">
                                        <div class="iconProduct">
                                            <img src="../Images/icon/contact/health/icon-health.png" alt="icon"/>
                                        </div>
                                        <div class="txtProduct">เมืองไทย Health Smile</div>
                                        <div class="clearPrefix"></div>
                                    </div>
                                </a>
                            </div>
