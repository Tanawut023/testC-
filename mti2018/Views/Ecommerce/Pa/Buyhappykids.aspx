		...
		<div class="row">
			...
			<div class="col-md-9">
                <div class="form-wrapper">
					...
					{
						%>
						<!-- #include file ="../../Shared/module/pa/happykids/plant.aspx" -->
						<%
					}
                    else if(Request.QueryString["p"]=="3")
					{
						%>
						<!-- #include file ="../../Shared/module/pa/happykids/formowner.aspx" -->
						<%
					}
                    else if(Request.QueryString["p"]=="4")
					{
						%>
						<!-- #include file ="../../Shared/module/pa/happykids/report.aspx" -->
						<%
					}
