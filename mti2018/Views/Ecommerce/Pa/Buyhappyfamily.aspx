		...
		<div class="row">
			...
			<div class="col-md-9">
                <div class="form-wrapper">
					...
					{
						%>
						<!-- #include file ="../../Shared/module/pa/happyfamily/plant.aspx" -->
						<%
					}
                    else if(Request.QueryString["p"]=="3")
					{
						%>
						<!-- #include file ="../../Shared/module/pa/happyfamily/formowner.aspx" -->
						<%
					}
                    else if(Request.QueryString["p"]=="4")
					{
						%>
						<!-- #include file ="../../Shared/module/pa/happyfamily/report.aspx" -->
						<%
					}
                        ...
                        <ul>
					        ...
					        if(Request.QueryString["p"]=="3")
					        {
                                ...
                                <li>
                                    <a href="#">
                                        <div class="icon">
                                            <img src="../../../Images/icon/icon-footerpa.png" alt="icon" />
                                        </div>
                                        <!--<div class="icon-i">
