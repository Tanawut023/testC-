		...
		<div class="row">
			...
			<div class="col-md-9">
                <div class="form-wrapper">
					...
					{
						%>
						<!-- #include file ="../../Shared/module/motor/muangthaidrive8/formcar.aspx" -->
						<%
					}
					...
					{
						%>
                        <!-- #include file ="../../Shared/module/motor/muangthaidrive8/formowner.aspx" -->
						<%
					}
					else if(Request.QueryString["p"]=="3")
					{
						%>
						<!-- #include file ="../../Shared/module/motor/muangthaidrive8/report.aspx" -->
						<%
					}
