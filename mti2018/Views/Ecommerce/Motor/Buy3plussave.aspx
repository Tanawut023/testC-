		...
		<div class="row">
			...
			<div class="col-md-9">
                <div class="form-wrapper">
					...
					{
						%>
						<!-- #include file ="../../Shared/module/motor/muangthai3plussave/formcar.aspx" -->
						<%
					}
					else if(Request.QueryString["p"]=="2")
					{
						%>
                        <!-- #include file ="../../Shared/module/motor/muangthai3plussave/formowner.aspx" -->
						<%
					}
					else if(Request.QueryString["p"]=="3")
					{
						%>
						<!-- #include file ="../../Shared/module/motor/muangthai3plussave/report.aspx" -->
						<%
					}
