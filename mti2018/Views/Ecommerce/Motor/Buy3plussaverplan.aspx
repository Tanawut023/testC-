		...
		<div class="row">
			...
			<div class="col-md-9">
                <div class="form-wrapper">
					...
					{
						%>
						<!-- #include file ="../../Shared/module/motor/muangthai3plussaverplan/formcar.aspx" -->
						<%
					}
					else if(Request.QueryString["p"]=="2")
					{
						%>
                        <!-- #include file ="../../Shared/module/motor/muangthai3plussaverplan/formowner.aspx" -->
						<%
					}
					else if(Request.QueryString["p"]=="3")
					{
						%>
						<!-- #include file ="../../Shared/module/motor/muangthai3plussaverplan/report.aspx" -->
						<%
					}
                    ...
                    <div class="footer-form">
                        <ul>
					        ...
					        if(Request.QueryString["p"]=="2")
					        {
						        %>
                                <li>
                                    <a href="../../../Images/PDF/Motor%20Add%20On_cover.pdf" target="_blank">
                                        <!--<div class="icon">
                                            <img src="../../../Images/icon/icon-footerform1.png" alt="icon" />
                                        </div>-->
                                        <div class="icon-i">
                                            <i class="fa fa-car" aria-hidden="true"></i>
                                        </div>
                                        <div class="text">รายละเอียดความคุ้มครองตามใจคุณและข้อยกเว้นเป็นไปตามเงื่อนไขในกรมธรรม์ ศึกษาเงื่อนไข <b>คลิ๊ก...</b></div>
                                    </a>
                                </li>
                                <li>
					        ...
					        else
					        {
                                ...
                                <!--<li>
                                    <a href="#">
                                        <div class="icon">
                                            <img src="../../../Images/icon/icon-footerform2.png" alt="icon" />
                                        </div>
                                        <div class="text">ABOUT SSL CERTIFICATES</div>
                                    </a>
                                </li>-->
						        <%
					        }
