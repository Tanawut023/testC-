		...
		<div class="row">
			...
			<div class="col-md-9">
                <div class="form-wrapper">
					...
					{
						%>
						<!-- #include file ="../../Shared/module/cancer/smileplus/plant.aspx" -->
						<%
					}
                    else if(Request.QueryString["p"]=="2")
					{
						%>
						<!-- #include file ="../../Shared/module/cancer/smileplus/formowner.aspx" -->
						<%
					}
                    else if(Request.QueryString["p"]=="3")
					{
						%>
						<!-- #include file ="../../Shared/module/cancer/smileplus/report.aspx" -->
						<%
					}
                        ...
                        <ul>
					        ...
					        if(Request.QueryString["p"]=="2")
					        {
                                ...
                                <li>
                                    <a href="#">
                                        <div class="icon">
                                            <img src="../../../Images/icon/icon-footercancer.png" alt="icon" />
                                        </div>
                                        <!--<div class="icon-i">
