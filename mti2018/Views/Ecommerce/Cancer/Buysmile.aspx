		...
		<div class="row">
			...
			<div class="col-md-9">
                <div class="form-wrapper">
					...
					{
						%>
						<!-- #include file ="../../Shared/module/cancer/smile/plant.aspx" -->
						<%
					}
                    else if(Request.QueryString["p"]=="2")
					{
						%>
						<!-- #include file ="../../Shared/module/cancer/smile/formowner.aspx" -->
						<%
					}
                    else if(Request.QueryString["p"]=="3")
					{
						%>
						<!-- #include file ="../../Shared/module/cancer/smile/report.aspx" -->
						<%
					}
