		...
		<div class="row">
			...
			<div class="col-md-9">
                <div class="form-wrapper">
					...
					{
						%>
						<!-- #include file ="../../Shared/module/ta/aroundthai/planttravel.aspx" -->
						<%
					}
                    else if(Request.QueryString["p"]=="3")
					{
						%>
						<!-- #include file ="../../Shared/module/ta/aroundthai/formowner.aspx" -->
						<%
					}
                    else if(Request.QueryString["p"]=="4")
					{
						%>
						<!-- #include file ="../../Shared/module/ta/aroundthai/report.aspx" -->
						<%
					}
