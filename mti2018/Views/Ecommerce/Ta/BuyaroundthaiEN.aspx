		...
		<div class="row">
			...
			<div class="col-md-9">
                <div class="form-wrapper">
					...
					{
						%>
						<!-- #include file ="../../Shared/module/ta/aroundthai/en/planttravel.aspx" -->
						<%
					}
                    else if(Request.QueryString["p"]=="3")
					{
						%>
						<!-- #include file ="../../Shared/module/ta/aroundthai/en/formowner.aspx" -->
						<%
					}
                    else if(Request.QueryString["p"]=="4")
					{
						%>
						<!-- #include file ="../../Shared/module/ta/aroundthai/en/report.aspx" -->
						<%
					}
					        ...
					        if(Request.QueryString["p"]=="3")
					        {
                                ...
                                <li>
                                    <a href="#">
                                        ...
                                        <div class="text">Coverage details</div>
                                    </a>
                                </li>
                                <li>
                                    <a href="/Callcenter/ContactCallcenter">
                                        ...
                                        <div class="text">Contact an officer</div>
                                    </a>
                                </li>
						        <%
					        }
